...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [SYM1] = LAYOUT_LR(  // Symbol layer.
    ...
    QK_LLCK, XXXXXXX, KC_EXLM, KC_PLUS, KC_MINS, XXXXXXX,
    XXXXXXX, XXXXXXX, KC_TILD, KC_PIPE, KC_AMPR, XXXXXXX,
                                                 _______, _______,

                      KC_F6  , KC_F7  , KC_F8  , KC_F9  , KC_F10 , KC_F11 ,
                      KC_EQL , KC_LBRC, KC_RBRC, KC_COLN, XXXXXXX, XXXXXXX,
                      KC_CIRC, KC_LPRN, KC_RPRN, KC_DLR , KC_BSLS, XXXXXXX,
                      KC_PERC, KC_LCBR, KC_RCBR, KC_SCLN, XXXXXXX, XXXXXXX,
             KC_DEL  , C(KC_F)
  ),
  ...
  [NUM] = LAYOUT_LR(  // Number layer.
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                      ...
                      KC_PERC, KC_0   , KC_DOT , KC_MINS, KC_SLSH, KC_MINS,
             _______, _______
  ),
